...
namespace Frontend.Repositories
{
    public class DashboardRepository : IDashboardRepository
    {
        ...
        {
            var response = await _httpClient.GetAsync("https://localhost:7238/api/Dashboard/GetDashboardData");
        ...
        {
            var response = await _httpClient.GetAsync("https://localhost:7238/api/Dashboard/GetOverdueBorrowers");
